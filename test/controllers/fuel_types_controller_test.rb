...
class FuelTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fuel_type" do
    assert_difference("FuelType.count") do
      post fuel_types_url, params: { fuel_type: { name: @fuel_type.name, price_per_liter: @fuel_type.price_per_liter } }
    end
  ...
  test "should update fuel_type" do
    patch fuel_type_url(@fuel_type), params: { fuel_type: { name: @fuel_type.name, price_per_liter: @fuel_type.price_per_liter } }
